    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE condor_branch (
                ...
                INDEX IDX_BRANCH_LEGAL (legal_entity_id),
                UNIQUE INDEX uniq_branch_tenant_slug (tenant_id, slug),
                PRIMARY KEY(id)
            ) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB
            SQL);
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE condor_membership (
                ...
                UNIQUE INDEX uniq_membership_tenant_user (tenant_id, user_id),
                PRIMARY KEY(id)
            ) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB
            SQL);
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE condor_tenant_domain (
                ...
                UNIQUE INDEX UNIQ_DOMAIN_HOSTNAME (hostname),
                PRIMARY KEY(id)
            ) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB
            SQL);
        ...
        $this->addSql(
            'ALTER TABLE condor_legal_entity '
            .'ADD CONSTRAINT FK_LEGAL_TENANT FOREIGN KEY (tenant_id) '
            .'REFERENCES condor_tenant (id) ON DELETE CASCADE',
        );
        $this->addSql(
            'ALTER TABLE condor_branch '
            .'ADD CONSTRAINT FK_BRANCH_TENANT FOREIGN KEY (tenant_id) '
            .'REFERENCES condor_tenant (id) ON DELETE CASCADE',
        );
        $this->addSql(
            'ALTER TABLE condor_branch '
        ...
        $this->addSql(
            ...
            .'ADD CONSTRAINT FK_MEMBERSHIP_TENANT FOREIGN KEY (tenant_id) '
            .'REFERENCES condor_tenant (id) ON DELETE CASCADE',
        );
        $this->addSql(
            'ALTER TABLE condor_membership '
        ...
        $this->addSql(
            ...
            .'ADD CONSTRAINT FK_DOMAIN_TENANT FOREIGN KEY (tenant_id) '
            .'REFERENCES condor_tenant (id) ON DELETE CASCADE',
        );
        $this->addSql(
            'ALTER TABLE condor_audit_event '
