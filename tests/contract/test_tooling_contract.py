...
class ToolingContractTests(unittest.TestCase):
    ...
    def test_release_workflow_delegates_to_factory_v1(self) -> None:
        """El release común usa Factory v1 y conserva config/version.php como fuente."""
        workflow = (
        ...
        self.assertIn("version_source: config/version.php", workflow)
        self.assertNotIn("gh release create", workflow)
        self.assertNotIn("git show-ref --verify", workflow)
...
"""
    ...
    def test_pdo_backup_hardening_is_wired_end_to_end(self) -> None:
        ...
        command = (
            ROOT / "src/Console/BackupDatabaseCommand.php"
        ).read_text(encoding="utf-8")
        ...
        self.assertIn("private readonly Connection $connection", pdo)
        self.assertIn("$this->connection->getNativeConnection()", pdo)
        self.assertNotIn("DriverManager", pdo)
