...
final class OrderController extends AbstractController
{
        ...
        return $this->json([
            ...
            'channels' => array_map(
                ...
                array_values(array_filter(
                    ...
                    static fn (SalesChannel $channel): bool => $channel->isPublishable(),
                )),
            ),
            'variants' => array_map(
                ...
                array_values(array_filter(
                    ...
                    static fn (ProductVariant $variant): bool => $variant->product()->isActive(),
                )),
            ),
        ]);
    }
    ...
    private function accessibleSources(
        ...
        return array_values(array_filter(
            $sources,
            function (InventorySource $source) use (
                $owner,
                $user,
                $tenant,
            ): bool {
